...
def user_input_features():
    starting_brds = st.sidebar.slider("How many BRDs a currently occuring per month? ", 25, 10000, 100)
    troop_rate = st.sidebar.slider("How many troops will be deployed per month? ", 1, 1000, 1000)
    total_troops = st.sidebar.slider("How many total troops will be deployed? ", 1, 1000000, 100000)
    num_months = st.sidebar.slider("How many months will the opperation last? ", 1, 500, 100)
...
st.write("With these parameters, it will take", prediction, " months to reach 0 battle-related deaths")
